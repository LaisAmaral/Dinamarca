function showPhoto(a) {
  ...
  var element1 = document.getElementById("imagem");
  var element3 = document.getElementById("imagem");
  var element4 = document.getElementById("imagem");
	var element2 = document.getElementById("descricao");


    if (a == "CP") {
		element.innerHTML = "<br><img src='img/cp1.jpg'</img>"; 
    element1.innerHTML = "<br><img src='img/cp2.jpg'</img>";
    element3.innerHTML = "<br><img src='img/cp3.jpg'</img>"; 
    element4.innerHTML = "<br><img src='img/cp4.jpg'</img>";
