function showPhoto(a) {
  ...
  if (a == "CP") {
    element.innerHTML = "<br><img src='img/cp6.jpg'</img>"; 
    ...
    element.innerHTML = "<br><img src='img/aa4.jpg'</img>";
    ...
    element.innerHTML = "<br><img src='img/sk5.jpg'</img>";
    ...
    element.innerHTML = "<br><img src='img/od2.jpg'</img>";
